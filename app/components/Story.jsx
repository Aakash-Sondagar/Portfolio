...
const Story = (props) => {
  const { story, goToPrevStory, goToNextStory, handleCloseClick } = props;

  const { slides, timer = 4000, thumbnail, topic } = story;
    ...
    <>
      ...
      <div className="flex h-full p-1">
        <div className="relative z-40  h-full w-full ">
          ...
          <div className="">
            <div className="absolute top-2 left-0 flex gap-x-2 items-center">
              <Image
                width={800}
                height={800}
            ...
            <h3 className="absolute bottom-2 ml-2 flex justify-center text-white ">
              {currentSlide.text}
            </h3>
          </div>
